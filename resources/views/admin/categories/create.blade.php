...
<div style="margin-bottom: 25px;">
    <h3 class="section-title"><i class="fas fa-plus"></i> Tambah Kategori Baru</h3>
</div>
...
<div class="form-container">
    <form action="/categories" method="POST">
        ...
        <div class="form-group @error('name') error @enderror">
            ...
            <input type="text" id="name" name="name" value="{{ old('name') }}" placeholder="Masukkan nama kategori" required>
            @error('name')
        ...
        <div class="form-group @error('description') error @enderror">
            ...
            <textarea id="description" name="description" placeholder="Masukkan deskripsi kategori" required>{{ old('description') }}</textarea>
            @error('description')
                <div class="error-message">{{ $message }}</div>
            @enderror
        </div>

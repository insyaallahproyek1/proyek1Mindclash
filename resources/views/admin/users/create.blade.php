...
<div class="form-container">
    <form action="/users" method="POST">
        ...
        <div class="form-group @error('name') error @enderror">
            ...
            <input type="text" id="name" name="name" value="{{ old('name') }}" placeholder="Masukkan nama pengguna" required>
            @error('name')
        ...
        <div class="form-row">
            ...
            <div class="form-group @error('class') error @enderror">
                ...
                <input type="text" id="class" name="class" value="{{ old('class') }}" placeholder="Contoh: 7A, 8B, 9C">
                @error('class')
                    <div class="error-message">{{ $message }}</div>
                @enderror
            </div>

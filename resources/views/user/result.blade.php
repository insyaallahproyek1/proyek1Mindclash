...
<html>
<head>
    <title>Hasil Quiz - {{ $category->name }}</title>
...
<div class="result-container">
    <div class="result-card">
        ...
        @if($percentage >= 80)
            <p class="result-message">Selamat! Kamu luar biasa! 🎉</p>
        @elseif($percentage >= 60)
            <p class="result-message">Bagus! Masih ada ruang untuk peningkatan 💪</p>
        @else
            <p class="result-message">Tetap semangat! Coba lagi untuk hasil yang lebih baik 📚</p>
        @endif
        ...
        <div class="percentage-bar">
            <div class="percentage-fill {{ $percentage >= 80 ? '' : ($percentage >= 60 ? 'medium' : 'low') }}" style="width: {{ $percentage }}%"></div>
        </div>
    </div>

    @if(count($questions) > 0)
    <div class="questions-review">
        <h2 class="review-title">Pembahasan Jawaban</h2>

...
@section('page_title', 'Edit Soal - MindClash')
    ...
    <form method="POST" action="{{ route('questions.update', $question->id) }}">
        ...
        <div class="form-group">
            ...
            <textarea name="question_text" class="form-control @error('question_text') is-invalid @enderror"
                      placeholder="Masukkan pertanyaan di sini..." required rows="4">{{ old('question_text', $question->question_text) }}</textarea>
            @error('question_text')
            <span class="invalid-feedback d-block">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="option_a" class="form-control @error('option_a') is-invalid @enderror"
                   placeholder="Teks pilihan A" value="{{ old('option_a', $question->option_a) }}" required>
            @error('option_a')
            <span class="invalid-feedback d-block">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="option_b" class="form-control @error('option_b') is-invalid @enderror"
                   placeholder="Teks pilihan B" value="{{ old('option_b', $question->option_b) }}" required>
            @error('option_b')
            <span class="invalid-feedback d-block">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="option_c" class="form-control @error('option_c') is-invalid @enderror"
                   placeholder="Teks pilihan C" value="{{ old('option_c', $question->option_c) }}" required>
            @error('option_c')
            <span class="invalid-feedback d-block">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="option_d" class="form-control @error('option_d') is-invalid @enderror"
                   placeholder="Teks pilihan D" value="{{ old('option_d', $question->option_d) }}" required>
            @error('option_d')
            <span class="invalid-feedback d-block">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="d-flex gap-2 mt-4">
            <button type="submit" class="btn-save"><i class="fas fa-save"></i> Perbarui Soal</button>

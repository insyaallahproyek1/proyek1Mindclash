...
<form method="POST" action="{{ route('questions.update', $question->id) }}">
    ...
    <textarea name="question_text" class="form-control mb-3 @error('question_text') is-invalid @enderror"
              placeholder="Enter the main question here..." required rows="4">{{ old('question_text', $question->question_text) }}</textarea>
    @error('question_text')
    <span class="invalid-feedback d-block">{{ $message }}</span>
    @enderror
    ...
    <input type="text" name="option_a" class="form-control mb-3 @error('option_a') is-invalid @enderror"
           placeholder="Type option A" value="{{ old('option_a', $question->option_a) }}" required>
    @error('option_a')
    <span class="invalid-feedback d-block">{{ $message }}</span>
    @enderror
    ...
    <input type="text" name="option_b" class="form-control mb-3 @error('option_b') is-invalid @enderror"
           placeholder="Type option B" value="{{ old('option_b', $question->option_b) }}" required>
    @error('option_b')
    <span class="invalid-feedback d-block">{{ $message }}</span>
    @enderror
    ...
    <input type="text" name="option_c" class="form-control mb-3 @error('option_c') is-invalid @enderror"
           placeholder="Type option C" value="{{ old('option_c', $question->option_c) }}" required>
    @error('option_c')
    <span class="invalid-feedback d-block">{{ $message }}</span>
    @enderror
    ...
    <input type="text" name="option_d" class="form-control mb-3 @error('option_d') is-invalid @enderror"
           placeholder="Type option D" value="{{ old('option_d', $question->option_d) }}" required>
    @error('option_d')
    <span class="invalid-feedback d-block">{{ $message }}</span>
    @enderror
